...
USE [DbName]
go
DROP TABLE IF EXISTS dbi_services.server_waitstatsv2_1
DROP TABLE IF EXISTS dbi_services.server_waitstatsv2_2

SELECT [wait_type], [waiting_tasks_count], [wait_time_ms],
       [max_wait_time_ms], [signal_wait_time_ms]
	INTO dbi_services.server_waitstatsv2_1
...
SELECT [wait_type], [waiting_tasks_count], [wait_time_ms],
       [max_wait_time_ms], [signal_wait_time_ms]
	INTO dbi_services.server_waitstatsv2_2
FROM sys.dm_os_wait_stats;
GO
...
-- Waits that weren't in the first snapshot
    ...
    FROM dbi_services.server_waitstatsv2_2 AS [ts2]
    LEFT OUTER JOIN dbi_services.server_waitstatsv2_1 AS [ts1]
