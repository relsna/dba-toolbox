...
,  convert(decimal(19,2),g.IntegerData*8/1024.) 
, g.StartTime
, convert(decimal(19,2),g.Duration/1000./1000.) -- Length of time necessary to extend the file.
, CASE WHEN mf.is_percent_growth = 1 THEN CONVERT(char(2), mf.growth) + '%'
ELSE CONVERT(varchar(30), convert(decimal(19,2), mf.growth*8./1024.)) + 'MB' END
, convert(decimal(19,2),mf.size* 8./1024.)
, CASE WHEN mf.max_size = -1 THEN 'Unlimited' ELSE convert(varchar(30), convert(decimal(19,2),mf.max_size*8./1024.)) END
